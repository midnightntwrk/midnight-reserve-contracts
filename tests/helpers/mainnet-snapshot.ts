...
const ZERO_FOREVER_DATUM = PlutusData.fromCore({
   constructor: 0n,
   fields: {
      items: [PlutusData.newInteger(0n).toCore(), PlutusData.newInteger(0n).toCore()],
   },
});
...
function toScriptAddress(script: Script): PaymentAddress {
   return PaymentAddress(addressFromValidator(NetworkId.Testnet, script).toBech32());
}
...
function snapshotToUtxo(
   ...
   return TransactionUnspentOutput.fromCore([
      ...
      {
         address:
            typeof address === "string" ? PaymentAddress(address) : PaymentAddress(address),
...
export function utxoRef(
   utxo:
      | TransactionUnspentOutput
      | Pick<SnapshotUtxo, "tx_hash" | "tx_index">,
): string {
...
const rawSnapshots = {
   techAuthForever: {
      ...
      tx_hash:
         "8dd59cc8ca3401bca9e4ab6b19d10ce31b0a9409acd890be2a359a3b272570a3",
      tx_index: 0,
      amount: [
   ...
   councilForever: {
      ...
      tx_hash:
         "4ed658573b4c74a43b18f0c90fd04f098497048267f230decef5ad55e5060765",
      tx_index: 0,
      amount: [
   ...
   mainGovThreshold: {
      ...
      tx_hash:
         "8ae50d9066a4c404f0e89cc5c732ba41f6b07e693f7f0d1d48cac2c41954a1a2",
      tx_index: 0,
      amount: [
   ...
   stagingGovThreshold: {
      ...
      tx_hash:
         "68058a74ec5438b99880673e621cb50e515a139a01e1da15b2fe8d43076b3100",
      tx_index: 0,
      amount: [
         { unit: "lovelace", quantity: "1060260" },
         {
   ...
   councilMain: {
      ...
      tx_hash:
         "d707ea8f7381d395cc3c56c8950104069f4874c8b4044c5994e0b13ea7e48fef",
      tx_index: 0,
      amount: [
   ...
   reserveMain: {
      ...
      tx_hash:
         "ddac4fc13e194185b39caea80ca00bb6d3d5b52155d8ff7a3896f8b344b2e2f2",
      tx_index: 0,
      amount: [
         { unit: "lovelace", quantity: "1340410" },
         {
   ...
   icsMain: {
      ...
      tx_hash:
         "99377821b0b39f1a9e9b7d99ec701bfeb92fbc18cd4e732bc9dde66d994328a4",
      tx_index: 0,
      amount: [
         { unit: "lovelace", quantity: "1340410" },
         {
   ...
   techAuthMain: {
      ...
      tx_hash:
         "82868cb4fb97b270945e4a86b933e8f3dcbd8adef6e903b8ba7fd87f02f62a1e",
      tx_index: 0,
      amount: [
         { unit: "lovelace", quantity: "1340410" },
         {
...
export const mainnetSnapshotUtxos = {
   ...
   councilMain: snapshotScriptUtxo(rawSnapshots.councilMain, contracts.councilTwoStage.Script),
   councilStaging: snapshotScriptUtxo(
      rawSnapshots.councilStaging,
      contracts.councilTwoStage.Script,
   ),
   reserveMain: snapshotScriptUtxo(rawSnapshots.reserveMain, contracts.reserveTwoStage.Script),
   reserveStaging: snapshotScriptUtxo(
      rawSnapshots.reserveStaging,
      contracts.reserveTwoStage.Script,
   ),
   icsMain: snapshotScriptUtxo(rawSnapshots.icsMain, contracts.icsTwoStage.Script),
   icsStaging: snapshotScriptUtxo(rawSnapshots.icsStaging, contracts.icsTwoStage.Script),
...
export const cnightAssetId = AssetId(
   aikenConfig.cnight_policy + Buffer.from(aikenConfig.cnight_name).toString("hex"),
);

export const mainnetReviewRefs = Object.fromEntries(
   Object.entries(rawSnapshots).map(([name, snapshot]) => [name, utxoRef(snapshot)]),
);

export const mainnetTokenAssetIds = {
   councilMain: AssetId(contracts.councilTwoStage.Script.hash() + MAIN_TOKEN_HEX),
   councilStaging: AssetId(contracts.councilTwoStage.Script.hash() + STAGING_TOKEN_HEX),
   reserveMain: AssetId(contracts.reserveTwoStage.Script.hash() + MAIN_TOKEN_HEX),
   reserveStaging: AssetId(contracts.reserveTwoStage.Script.hash() + STAGING_TOKEN_HEX),
   ...
   techAuthMain: AssetId(contracts.techAuthTwoStage.Script.hash() + MAIN_TOKEN_HEX),
   techAuthStaging: AssetId(contracts.techAuthTwoStage.Script.hash() + STAGING_TOKEN_HEX),
};
