...
exports.IntegratedDemoExecutor = void 0;
...
class IntegratedDemoExecutor {
    ...
    async executeSingleCodeBlock(codeContent) {
    ...
    async executeCodeBlock(blockIndex) {
        ...
        console.log = (...args) => {
            capturedOutput.push(args.map(arg => typeof arg === 'object' ? JSON.stringify(arg, null, 2) : String(arg)).join(' '));
...
exports.IntegratedDemoExecutor = IntegratedDemoExecutor;
